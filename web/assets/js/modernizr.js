...
!((e, n, t, o) => {
	...
	function A(e, n, o, a) {
		var r,
			...
			f = i("div"),
			d = s();
		if (Number.parseInt(o, 10))
			while (o--) (l = i("div")), (l.id = a ? a[o] : c + (o + 1)), f.appendChild(l);
		return (
			(r = i("style")),
			(r.type = "text/css"),
			(r.id = "s" + c),
	...
	var v = (() => {
		...
		return e
			...
			: (e) => {
					var n = !1;
					return (
						A("@media " + e + " { #modernizr { position: absolute; } }", (e) => {
	...
	!(() => {
		...
		m =
			a(e, "undefined") || a(e.call, "undefined")
				? (e, n) => n in e && a(e.constructor.prototype[n], "undefined")
				: (n, t) => e.call(n, t);
	})(),
		(f._l = {}),
		(f.on = function (e, n) {
		...
		Modernizr.addTest("webgl", () => "WebGLRenderingContext" in n),
		Modernizr.addAsyncTest(() => {
